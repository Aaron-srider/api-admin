...
export let srcRoutes = [
...

    {
        path: '/db-auto-backup',
        component: Layout,
        redirect: '/db-auto-backup/index',
        name: 'api-admin',
        alwaysShow: false,
        meta: { title: '自动备份', icon: 'ali-international-icon-file-backup' },
        children: [
            {
                path: 'index',
                name: 'db-auto-backup_index',
                component: () => import('@/views/db-auto-backup/index'),
                meta: {
                    title: '自动备份',
                    icon: 'ali-international-icon-file-backup',
                },
            },

            {
                path: 'log',
                name: 'db-auto-backup_log',
                component: () => import('@/views/db-auto-backup/log/index'),
                meta: {
                    title: '日志',
                    icon: 'ali-international-icon-jurassic_log',
                },
                hidden: true,
            },
        ],
